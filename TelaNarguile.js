...
const produtos = [
  {
    id: 99,
    nome: 'Narguile Zeus',
    descricao: 'NARGUILÉ COMPLETO PEQUENO 80 CM',
    preco: 170.0,
    imagem: require('./img/narguile1.png'),
  },
  {
    id: 100,
   nome: 'Narguile  Empire',
   descricao: 'NARGUILÉ COMPLETO PEQUENO 35 CM', 
    preco: 100.0,
    imagem: require('./img/narguileazul.jpg'),
  },
  {
    id: 101,
    nome: 'Narguile Triton',
    descricao: 'NARGUILÉ COMPLETO MEDIO 50 CM', 
    preco: 125.0,
    imagem: require('./img/narguilerosa.jpg'),
  },
];

export default function TelaNarguile({ navigation }) {
  ...
  return (
    <View style={estilos.container}>
      ...
      <View style={estilos.bannerContainerNarguile}>
          <Image
            style={estilos.bannerImagemNarguile}
            source={require('./img/bannernarguile.png')}
          />
        </View>
  <View style={estilos.secaoProdutos}>
  <View style={estilos.textsecao}>
    <Text style={estilos.tituloSecao}>Narguiles montados</Text>
  </View>  
